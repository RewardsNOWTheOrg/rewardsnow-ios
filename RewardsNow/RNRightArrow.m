...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.isHighlighted) {
        ...
        //// Group
        {
            ...
            [roundedRectanglePath moveToPoint: CGPointMake(0.42, 25.16)];
            [roundedRectanglePath addCurveToPoint: CGPointMake(3.79, 28.57) controlPoint1: CGPointMake(0.42, 27.05) controlPoint2: CGPointMake(1.93, 28.57)];
            [roundedRectanglePath addLineToPoint: CGPointMake(28.21, 28.57)];
            [roundedRectanglePath addCurveToPoint: CGPointMake(31.58, 25.16) controlPoint1: CGPointMake(30.07, 28.57) controlPoint2: CGPointMake(31.58, 27.05)];
            [roundedRectanglePath addLineToPoint: CGPointMake(31.58, 3.84)];
            [roundedRectanglePath addCurveToPoint: CGPointMake(28.21, 0.43) controlPoint1: CGPointMake(31.58, 1.95) controlPoint2: CGPointMake(30.07, 0.43)];
            [roundedRectanglePath addLineToPoint: CGPointMake(3.79, 0.43)];
            [roundedRectanglePath addCurveToPoint: CGPointMake(0.42, 3.84) controlPoint1: CGPointMake(1.93, 0.43) controlPoint2: CGPointMake(0.42, 1.95)];
            [roundedRectanglePath addLineToPoint: CGPointMake(0.42, 25.16)];
            [roundedRectanglePath closePath];
            CGContextSaveGState(context);
            [roundedRectanglePath addClip];
            CGContextDrawLinearGradient(context, gradient, CGPointMake(16, 0.43), CGPointMake(16, 28.57), 0);
            ...
            [bezierPath moveToPoint: CGPointMake(11.37, 8.1)];
            [bezierPath addLineToPoint: CGPointMake(21.89, 14.19)];
            [bezierPath addLineToPoint: CGPointMake(11.37, 20.47)];
            [bezierPath addLineToPoint: CGPointMake(11.37, 8.1)];
        ...
        //// Group
        {
            ...
            //// Bezier Drawing
            UIBezierPath* bezierPath = [UIBezierPath bezierPath];
            [bezierPath moveToPoint: CGPointMake(11.57, 20.89)];
            [bezierPath addLineToPoint: CGPointMake(22.4, 14.5)];
            [bezierPath addLineToPoint: CGPointMake(11.57, 8.11)];
            [bezierPath addLineToPoint: CGPointMake(11.57, 20.89)];
            [bezierPath closePath];
            [fillColor2 setFill];
            [bezierPath fill];
        }
