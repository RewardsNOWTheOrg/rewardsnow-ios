...
- (id)initWithCoder:(NSCoder *)aDecoder {
    if ( (self = [super initWithCoder:aDecoder]) ) {
        self.contentView.backgroundColor = [[RNBranding sharedBranding] commonBackgroundColor];
        self.flipBackgroundView.backgroundColor = [[RNBranding sharedBranding] commonBackgroundColor];
    }
    return self;
}
